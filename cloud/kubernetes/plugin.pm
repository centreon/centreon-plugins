...
sub new {
    ...
    %{$self->{modes}} = (
        ...
        'list-persistent-volumes'       => 'cloud::kubernetes::mode::listpersistentvolumes',
        'list-pods'                     => 'cloud::kubernetes::mode::listpods',
        'list-replicasets'              => 'cloud::kubernetes::mode::listreplicasets',
        'list-replication-controllers'  => 'cloud::kubernetes::mode::listreplicationcontrollers',
        ...
        'persistent-volume-status'      => 'cloud::kubernetes::mode::persistentvolumestatus',
        'pod-status'                    => 'cloud::kubernetes::mode::podstatus',
        'replicaset-status'             => 'cloud::kubernetes::mode::replicasetstatus',
        'replication-controller-status' => 'cloud::kubernetes::mode::replicationcontrollerstatus',
