...
package cloud::azure::management::apimanagement::mode::duration;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'backendduration' => {
            'output' => 'Duration of Backend Requests',
            'label'  => 'requests-backend-duration',
            'nlabel' => 'apimanagement.requests.backend.duration.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        },
        'duration' => {
            'output' => 'Overall Duration of Gateway Requests',
            'label'  => 'requests-duration',
            'nlabel' => 'apimanagement.requests.duration.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        }
    };
...
Check Azure API Management requests duration statistics.
...
''requests-backend-duration', 'requests-duration'.
