...
package cloud::azure::management::apimanagement::mode::requests;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'requests' => {
            'output' => 'Requests',
            'label'  => 'requests',
            'nlabel' => 'apimanagement.requests.count',
            'unit'   => '',
            'min'    => '0'
        }
    };
...
Check Azure API Management requests statistics.
...
--aggregation='average' --warning-requests='1000' --critical-requests='2000'
...
Warning threshold for the number of requests.

=item B<--critical-requests>

Critical threshold for the number of requests.
