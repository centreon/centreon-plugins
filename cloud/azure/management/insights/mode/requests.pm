...
package cloud::azure::management::insights::mode::httprequests;
...
perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=http-requests --custommode=api
...
--aggregation='total' --warning-requests-count='800' --critical-requests-count='900'
