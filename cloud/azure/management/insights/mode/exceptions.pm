...
package cloud::azure::management::insights::mode::exceptions;
...
perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=exceptions --custommode=api
