...
package cloud::azure::management::insights::mode::availability;
...
Check Azure Application Insights availability status.

Example:

Using resource name :

perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=availability --custommode=api
...
--aggregation='average' --warning-availability='80:' --critical-availability='90:'
...
'availability', 'tests-count', 'tests-duration'.
