...
package cloud::azure::management::insights::mode::dependencies;
...
perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=dependencies --custommode=api
