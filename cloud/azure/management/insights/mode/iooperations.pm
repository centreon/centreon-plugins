...
package cloud::azure::management::insights::mode::iooperations;
...
Check Azure Application Insights io-operations status.

Example:

Using resource name :

perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=io-operations --custommode=api
