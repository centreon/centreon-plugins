...
package cloud::azure::management::insights::mode::pageviews;
...
perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=pageviews --custommode=api
...
--aggregation='total' --warning-views-count='800' --critical-views-count='900'
