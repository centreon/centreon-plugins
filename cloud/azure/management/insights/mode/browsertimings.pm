...
package cloud::azure::management::insights::mode::browsertimings;
...
perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=browser-timings --custommode=api
