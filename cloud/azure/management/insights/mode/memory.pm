...
package cloud::azure::management::insights::mode::memory;
...
perl centreon_plugins.pl --plugin=cloud::azure::management::insights::plugin --mode=memory --custommode=api
...
--aggregation='average' --warning-memory-available='8000' --critical-memory-available='900'
...
'memory-available', 'memory-private'.
