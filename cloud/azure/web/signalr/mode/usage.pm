...
package cloud::azure::web::signalr::mode::usage;
...
--aggregation='total' --warning-connection-count='800' --critical-connection-count='900'
...
'message-count', connection-count'.
