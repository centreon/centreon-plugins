...
package cloud::azure::security::keyvault::mode::serviceapi;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'serviceapihit' => {
            'output' => 'Total Service Api Hits',
            'label'  => 'serviceapi-hits',
            'nlabel' => 'keyvault.serviceapi.hits.count',
            'unit'   => '',
            'min'    => '0'
        },
        'serviceapilatency' => {
            'output' => 'Overall Service Api Latency',
            'label'  => 'serviceapi-latency',
            'nlabel' => 'keyvault.serviceapi.latency.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        },
        'serviceapiresult' => {
            'output' => 'Total Service Api Results',
            'label'  => 'serviceapi-results',
            'nlabel' => 'keyvault.serviceapi.results.count',
            'unit'   => '',
            'min'    => '0'
        }
    };
...
Check Azure Security Key Vault serviceAPI statistics.

Example:

Using resource name :

perl centreon_plugins.pl --plugin=cloud::azure::security::keyvault::plugin --mode=service-api --custommode=api
