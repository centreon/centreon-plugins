...
package cloud::azure::network::firewall::mode::hits;
...
--aggregation='total' --warning-application-rules-hits='5000' --critical-application-rules-hits='10000'
...
'application-rules-hits', 'network-rules-hits'.
