...
package cloud::azure::network::appgateway::mode::connections;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'currentconnections' => {
            ...
            'nlabel' => 'appgateway.backend.connections.current.count',
            'unit'   => '',
            'min'    => '0'
        }
    };
...
Check Azure Application Gateway connections statistics.
