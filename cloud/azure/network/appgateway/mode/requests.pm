...
package cloud::azure::network::appgateway::mode::requests;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'failedrequests' => {
            ...
            'nlabel' => 'appgateway.requests.failed.count',
            'unit'   => '',
            'min'    => '0'
        },
        'totalrequests' => {
            ...
            'nlabel' => 'appgateway.requests.total.count',
            'unit'   => '',
            'min'    => '0'
        }
    };
...
Check Azure Application Gateway requests statistics.

Example:

Using resource name :

perl centreon_plugins.pl --plugin=cloud::azure::network::appgateway::plugin --mode=requests --custommode=api
--resource=<appgateway_id> --resource-group=<resourcegroup_id> --aggregation='total'
--warning-failed-requests='1000' --critical-failed-requests='2000'
...
--aggregation='total' --warning-failed-requests='1000' --critical-failed-requests='2000'
