...
package cloud::azure::network::appgateway::mode::backendtime;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'backendconnecttime' => {
            'output' => 'Backend Connect Time',
            'label'  => 'connect-time',
            'nlabel' => 'appgateway.backend.connect.time.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        },
        'backendfirstbyteresponsetime' => {
            'output' => 'Backend First Byte Response Time',
            'label'  => 'firstbyte-response-time',
            'nlabel' => 'appgateway.backend.firstbyte.responsetime.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        },
        'backendlastbyteresponsetime' => {
            'output' => 'Backend Last Byte Response Time',
            'label'  => 'lastbyte-response-time',
            'nlabel' => 'appgateway.backend.lastbyte.responsetime.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        }
    };
