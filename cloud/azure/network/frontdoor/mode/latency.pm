...
package cloud::azure::network::frontdoor::mode::latency;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'backendrequestlatency' => {
            'output' => 'Backend Request Latency',
            'label'  => 'backend-request-latency',
            'nlabel' => 'frontdoor.latency.backend.milliseconds',
            'unit'   => 'ms',
            'min'    => '0',
            'max'    => ''
        },
        'totallatency' => {
            ...
            'label'  => 'total-latency',
            'nlabel' => 'frontdoor.latency.total.milliseconds',
            'unit'   => 'ms',
            'min'    => '0',
            'max'    => ''
        }
...
perl centreon_plugins.pl --plugin=cloud::azure::network::frontdoor::plugin --mode=latency --custommode=api
...
'total-latency', 'backend-request-latency'.
