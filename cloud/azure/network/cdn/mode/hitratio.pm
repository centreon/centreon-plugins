...
package cloud::azure::network::cdn::mode::hitratio;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'bytehitratio' => {
            'output' => 'Byte Hit Ratio',
            'label'  => 'byte-hit-percentage',
            'nlabel' => 'cdn.byte.hit.percentage',
            'unit'   => '%',
            'min'    => '0',
            'max'    => '100'
        }
...
Check Azure CDN byte hit ratio.
...
--aggregation='average' --warning-byte-hit-percentage='20:' --critical-byte-hit-percentage='10:'
...
=item B<--warning-byte-hit-percentage>
