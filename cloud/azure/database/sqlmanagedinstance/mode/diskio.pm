...
package cloud::azure::database::sqlmanagedinstance::mode::diskio;
...
Check Azure SQL Managed Instance  disk IO.
...
--aggregation='average' --warning-bytes-written='80'' --critical-bytes-written='90'
