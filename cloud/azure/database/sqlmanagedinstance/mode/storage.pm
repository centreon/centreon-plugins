...
package cloud::azure::database::sqlmanagedinstance::mode::storage;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'reserved_storage_mb' => {
            'output' => 'Storage space reserved',
            'label'  => 'reserved',
            'nlabel' => 'sqlmanagedinstance.storage.space.reserved.count',
            'unit'   => '',
            'min'    => '0',
            'max'    => ''
        },
        'storage_space_used_mb' => {
            'output' => 'Storage space used',
            'label'  => 'used',
            'nlabel' => 'sqlmanagedinstance.storage.space.used.count',
            'unit'   => '',
            'min'    => '0',
            'max'    => ''
        },
...
Check Azure SQL Managed Instance storage.
...
--aggregation='average' --warning-used='80'' --critical-used='90'
