...
package cloud::azure::database::cosmosdb::mode::latency;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'replicationlatency' => {
            'output' => 'P99 Replication Latency',
            'label'  => 'replication-latency',
            'nlabel' => 'cosmosdb.account.latency.replication.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        },
       'serversidelatency' => {
            'output' => 'Server Side Latency',
            'label'  => 'serverside-latency',
            'nlabel' => 'cosmosdb.account.latency.serverside.milliseconds',
            'unit'   => 'ms',
            'min'    => '0'
        }
    };
...
Check Azure Cosmos DB Accounts latency statistics.
...
--aggregation='average' --warning-serverside-latency='800' --critical-serverside-latency='900'
