...
$fatpacked{"network/hp/procurve/snmp/mode/components/temperature.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_COMPONENTS_TEMPERATURE';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/hp/procurve/snmp/mode/interfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_INTERFACES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/hp/procurve/snmp/mode/stack.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_STACK';
  #
...
$fatpacked{"network/hp/procurve/snmp/mode/virtualchassis.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_HP_PROCURVE_SNMP_MODE_VIRTUALCHASSIS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
