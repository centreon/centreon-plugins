...
$fatpacked{"network/alcatel/oxe/snmp/mode/domains.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ALCATEL_OXE_SNMP_MODE_DOMAINS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/alcatel/oxe/snmp/mode/trunks.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ALCATEL_OXE_SNMP_MODE_TRUNKS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
