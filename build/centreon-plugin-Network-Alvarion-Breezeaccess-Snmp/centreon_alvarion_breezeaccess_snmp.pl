...
$fatpacked{"network/alvarion/breezeaccess/snmp/mode/radiostatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ALVARION_BREEZEACCESS_SNMP_MODE_RADIOSTATUS';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/alvarion/breezeaccess/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ALVARION_BREEZEACCESS_SNMP_PLUGIN';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
