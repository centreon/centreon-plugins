...
$fatpacked{"network/symbol/wing/snmp/mode/systems.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SYMBOL_WING_SNMP_MODE_SYSTEMS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/symbol/wing/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_SYMBOL_WING_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
