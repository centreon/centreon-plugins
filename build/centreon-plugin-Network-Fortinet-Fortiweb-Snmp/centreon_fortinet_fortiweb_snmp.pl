...
$fatpacked{"network/fortinet/fortiweb/snmp/mode/proxy.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIWEB_SNMP_MODE_PROXY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/fortinet/fortiweb/snmp/mode/system.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIWEB_SNMP_MODE_SYSTEM';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/fortinet/fortiweb/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_FORTINET_FORTIWEB_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
