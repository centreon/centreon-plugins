...
$fatpacked{"network/dlink/standard/snmp/mode/interfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_DLINK_STANDARD_SNMP_MODE_INTERFACES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/dlink/standard/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_DLINK_STANDARD_SNMP_MODE_MEMORY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/dlink/standard/snmp/mode/stack.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_DLINK_STANDARD_SNMP_MODE_STACK';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
