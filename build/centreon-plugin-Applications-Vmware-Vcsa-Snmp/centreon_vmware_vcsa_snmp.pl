...
$fatpacked{"apps/vmware/vcsa/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_SNMP_MODE_CPU';
  #
...
$fatpacked{"apps/vmware/vcsa/snmp/mode/interfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_SNMP_MODE_INTERFACES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/vcsa/snmp/mode/listinterfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_SNMP_MODE_LISTINTERFACES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/vcsa/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_SNMP_MODE_MEMORY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/vcsa/snmp/mode/storage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_SNMP_MODE_STORAGE';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/vcsa/snmp/mode/uptime.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_SNMP_MODE_UPTIME';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/vcsa/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
