...
$fatpacked{"centreon/common/cisco/smallbusiness/snmp/mode/components/resources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_CISCO_SMALLBUSINESS_SNMP_MODE_COMPONENTS_RESOURCES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/cisco/smallbusiness/snmp/mode/components/temperature.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_CISCO_SMALLBUSINESS_SNMP_MODE_COMPONENTS_TEMPERATURE';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/cisco/smallbusiness/snmp/mode/stack.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_CISCO_SMALLBUSINESS_SNMP_MODE_STACK';
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
