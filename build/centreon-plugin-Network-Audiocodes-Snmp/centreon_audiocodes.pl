...
$fatpacked{"network/audiocodes/snmp/mode/interfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_AUDIOCODES_SNMP_MODE_INTERFACES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/audiocodes/snmp/mode/sbccalls.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_AUDIOCODES_SNMP_MODE_SBCCALLS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
