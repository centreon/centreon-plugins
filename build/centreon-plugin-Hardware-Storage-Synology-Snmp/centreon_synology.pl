...
$fatpacked{"storage/synology/snmp/mode/ha.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_SYNOLOGY_SNMP_MODE_HA';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/synology/snmp/mode/upgrade.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_SYNOLOGY_SNMP_MODE_UPGRADE';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
