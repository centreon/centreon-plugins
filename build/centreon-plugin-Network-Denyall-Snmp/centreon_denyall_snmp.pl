...
$fatpacked{"network/denyall/snmp/mode/listreverseproxy.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_DENYALL_SNMP_MODE_LISTREVERSEPROXY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/denyall/snmp/mode/reverseproxy.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_DENYALL_SNMP_MODE_REVERSEPROXY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/denyall/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_DENYALL_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
