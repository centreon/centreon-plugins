...
$fatpacked{"centreon/common/frogfoot/snmp/mode/load.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_FROGFOOT_SNMP_MODE_LOAD';
  #
...
$fatpacked{"centreon/common/frogfoot/snmp/mode/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_FROGFOOT_SNMP_MODE_MEMORY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/ubiquiti/airfiber/snmp/mode/listradios.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UBIQUITI_AIRFIBER_SNMP_MODE_LISTRADIOS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/ubiquiti/airfiber/snmp/mode/radios.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UBIQUITI_AIRFIBER_SNMP_MODE_RADIOS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/ubiquiti/airfiber/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UBIQUITI_AIRFIBER_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
