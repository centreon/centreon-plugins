...
$fatpacked{"network/paloalto/snmp/mode/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_PALOALTO_SNMP_MODE_CPU';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/paloalto/snmp/mode/gpusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_PALOALTO_SNMP_MODE_GPUSAGE';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/paloalto/snmp/mode/signatures.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_PALOALTO_SNMP_MODE_SIGNATURES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
