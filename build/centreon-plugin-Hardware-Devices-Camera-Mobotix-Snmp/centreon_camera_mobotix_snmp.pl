...
$fatpacked{"hardware/devices/camera/mobotix/snmp/mode/system.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_CAMERA_MOBOTIX_SNMP_MODE_SYSTEM';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/camera/mobotix/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_CAMERA_MOBOTIX_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
