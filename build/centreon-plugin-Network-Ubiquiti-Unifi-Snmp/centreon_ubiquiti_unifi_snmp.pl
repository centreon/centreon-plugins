...
$fatpacked{"network/ubiquiti/unifi/snmp/mode/listvirtualaccesspoints.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UBIQUITI_UNIFI_SNMP_MODE_LISTVIRTUALACCESSPOINTS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/ubiquiti/unifi/snmp/mode/virtualaccesspoints.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UBIQUITI_UNIFI_SNMP_MODE_VIRTUALACCESSPOINTS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/ubiquiti/unifi/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_UBIQUITI_UNIFI_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
