...
$fatpacked{"hardware/telephony/avaya/aes/snmp/mode/services.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_TELEPHONY_AVAYA_AES_SNMP_MODE_SERVICES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/telephony/avaya/aes/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_TELEPHONY_AVAYA_AES_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
