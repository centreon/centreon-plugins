...
$fatpacked{"network/watchguard/snmp/mode/cluster.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_WATCHGUARD_SNMP_MODE_CLUSTER';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/watchguard/snmp/mode/ipsectunnel.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_WATCHGUARD_SNMP_MODE_IPSECTUNNEL';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
