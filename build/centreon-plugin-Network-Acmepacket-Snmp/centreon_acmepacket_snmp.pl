...
$fatpacked{"network/acmepacket/snmp/mode/codec.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ACMEPACKET_SNMP_MODE_CODEC';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/acmepacket/snmp/mode/listpolicyservers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ACMEPACKET_SNMP_MODE_LISTPOLICYSERVERS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/acmepacket/snmp/mode/policyservers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ACMEPACKET_SNMP_MODE_POLICYSERVERS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/acmepacket/snmp/mode/security.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_ACMEPACKET_SNMP_MODE_SECURITY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
