...
$fatpacked{"apps/trendmicro/iwsva/snmp/mode/interfaces.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TRENDMICRO_IWSVA_SNMP_MODE_INTERFACES';
  #
...
$fatpacked{"apps/trendmicro/iwsva/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_TRENDMICRO_IWSVA_SNMP_PLUGIN';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
