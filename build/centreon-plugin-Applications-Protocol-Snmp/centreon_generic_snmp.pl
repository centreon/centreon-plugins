...
$fatpacked{"apps/protocols/snmp/mode/cache.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_SNMP_MODE_CACHE';
  #
...
$fatpacked{"apps/protocols/snmp/mode/collection.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROTOCOLS_SNMP_MODE_COLLECTION';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"snmp_standard/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'SNMP_STANDARD_MODE_DISCOVERY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
