...
$fatpacked{"hardware/server/ibm/mgmt_cards/imm/snmp/mode/components/cpu.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_IBM_MGMT_CARDS_IMM_SNMP_MODE_COMPONENTS_CPU';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/server/ibm/mgmt_cards/imm/snmp/mode/components/disk.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_IBM_MGMT_CARDS_IMM_SNMP_MODE_COMPONENTS_DISK';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/server/ibm/mgmt_cards/imm/snmp/mode/components/memory.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_IBM_MGMT_CARDS_IMM_SNMP_MODE_COMPONENTS_MEMORY';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/server/ibm/mgmt_cards/imm/snmp/mode/components/power.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_IBM_MGMT_CARDS_IMM_SNMP_MODE_COMPONENTS_POWER';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
