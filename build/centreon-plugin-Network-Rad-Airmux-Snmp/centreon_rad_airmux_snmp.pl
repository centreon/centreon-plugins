...
$fatpacked{"network/rad/airmux/snmp/mode/alarms.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_RAD_AIRMUX_SNMP_MODE_ALARMS';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/rad/airmux/snmp/mode/radiostatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_RAD_AIRMUX_SNMP_MODE_RADIOSTATUS';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"network/rad/airmux/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NETWORK_RAD_AIRMUX_SNMP_PLUGIN';
  #
  # Copyright 2018 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
