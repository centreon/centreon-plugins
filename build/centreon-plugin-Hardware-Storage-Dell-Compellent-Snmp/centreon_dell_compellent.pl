...
$fatpacked{"storage/dell/compellent/snmp/mode/components/diskfolder.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_DELL_COMPELLENT_SNMP_MODE_COMPONENTS_DISKFOLDER';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/dell/compellent/snmp/mode/globalstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_DELL_COMPELLENT_SNMP_MODE_GLOBALSTATUS';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
