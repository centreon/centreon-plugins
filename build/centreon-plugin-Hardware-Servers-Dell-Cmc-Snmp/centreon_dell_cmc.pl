...
$fatpacked{"hardware/server/dell/cmc/snmp/mode/components/disk.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_DELL_CMC_SNMP_MODE_COMPONENTS_DISK';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/server/dell/cmc/snmp/mode/components/resources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_DELL_CMC_SNMP_MODE_COMPONENTS_RESOURCES';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/server/dell/cmc/snmp/mode/components/vdisk.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_DELL_CMC_SNMP_MODE_COMPONENTS_VDISK';
  #
  # Copyright 2024 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
