...
package network::meru::snmp::mode::memory;
...
sub manage_selection {
    ...
    my $oid_total = '.1.3.6.1.4.1.15983.1.1.3.1.14.4.0'; # mwSystemResourceMemoryTotalSize
    my $oid_free = '.1.3.6.1.4.1.15983.1.1.3.1.14.6.0'; # mwSystemResourceMemoryFreeSize
