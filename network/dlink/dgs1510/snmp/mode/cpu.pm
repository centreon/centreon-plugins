...
package network::dlink::dgs1510::snmp::mode::cpu;
...
sub run {
    ...
    my $oid_agentCPUutilizationIn5sec = '.1.3.6.1.4.1.171.14.5.1.7.1.3.1.1';
    my $oid_agentCPUutilizationIn1min = '.1.3.6.1.4.1.171.14.5.1.7.1.4.1.1';
    my $oid_agentCPUutilizationIn5min = '.1.3.6.1.4.1.171.14.5.1.7.1.5.1.1';
