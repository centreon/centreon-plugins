...
package network::dlink::dgs1510::snmp::mode::components::fan;
...
# In MIB 'env_mib.mib'
my $mapping = {
    swFanStatus => { oid => '.1.3.6.1.4.1.171.14.5.1.1.2.1.4', map => \%map_states },
};
my $oid_swFanEntry = '.1.3.6.1.4.1.171.14.5.1.1.2.1';
