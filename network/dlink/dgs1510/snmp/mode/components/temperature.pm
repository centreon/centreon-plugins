...
package network::dlink::dgs1510::snmp::mode::components::temperature;
...
# In MIB 'env_mib.mib'
my $mapping = {
    swTemperatureCurrent => { oid => '.1.3.6.1.4.1.171.14.5.1.1.1.1.4' },
};
my $oid_swTemperatureEntry = '.1.3.6.1.4.1.171.14.5.1.1.1.1';
