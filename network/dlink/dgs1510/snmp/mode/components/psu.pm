...
package network::dlink::dgs1510::snmp::mode::components::psu;
...
my $mapping = {
    swPowerStatus => { oid => '.1.3.6.1.4.1.171.14.5.1.1.3.1.6', map => \%map_states },
};
my $oid_swPowerEntry = '.1.3.6.1.4.1.171.14.5.1.1.3.1';
