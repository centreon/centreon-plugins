...
sub run {
    ...
    my $mapping = {
        ...
        aos7 => {
            entry_module => '.1.3.6.1.4.1.6486.800.1.2.1.16.1.1.1.1.1',
            module => {
                healthModuleMemory1MinAvg  => { oid => '.1.3.6.1.4.1.6486.800.1.2.1.16.1.1.1.1.1.8' },
                healthModuleMemory1HrAvg   => { oid => '.1.3.6.1.4.1.6486.800.1.2.1.16.1.1.1.1.1.9' },
            },
        },
    };
