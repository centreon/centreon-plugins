...
package network::alcatel::oxe::snmp::mode::trunkusage;
...
sub set_counters {
    ...
    $self->{maps_counters_type} = [
        { name => 'trunk', type => 1, cb_prefix_output => 'prefix_trunk_output', message_multiple => 'All domain are ok', skipped_code => { -2 => 1, -10 => 1 } }
    ];
