...
my $thresholds = {
    ...
    'dimm-correctable-errors-last-day' => [
        ['0', 'OK'],
        ['.*', 'CRITICAL'],
    ],
...
sub run {
    ...
    my @sensors = ('dimm-health-state','node-health-state','current-health-state', 'journal-state', 'temperature-health-state', 'fan-health-state',
                   'dimm-correctable-errors-last-day', 'node-fp-temperature-state', 'sas1-port-health-state', 'sas2-port-health-state');
...
Check storage controller health indicators ('dimm-health-state','node-health-state','current-health-state', 'journal-state', 'temperature-health-state', 'fan-health-state',
                                            'dimm-correctable-errors-last-day', 'node-fp-temperature-state', 'sas1-port-health-state', 'sas2-port-health-state');
...
Overload a specific threshold, e.g --threshold-overload="fan-health-state,SC-X1,CRITICAL,healthy"
