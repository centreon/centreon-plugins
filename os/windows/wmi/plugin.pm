...
sub new {
    ...
    %{$self->{modes}} = (
        ...
        'folder-size'      => 'os::windows::wmi::mode::foldersize',
        'list-interfaces'  => 'os::windows::wmi::mode::listinterfaces',
        'list-processes'   => 'os::windows::wmi::mode::listprocesses',
        'list-services'    => 'os::windows::wmi::mode::listservices',
        'list-storages'    => 'snmp_standard::mode::liststorages',
        'memory'           => 'os::windows::wmi::mode::memory',
        'processcount'     => 'os::windows::wmi::mode::processcount',
        'service'          => 'os::windows::wmi::mode::service',
