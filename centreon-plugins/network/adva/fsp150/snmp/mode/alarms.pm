...
sub manage_selection {
    ...
    my $snmp_result = $options{snmp}->get_table(oid => '.1.3.6.1.4.1.2544.1.12.3.1.4.1.5');
    use Data::Dumper; print Data::Dumper::Dumper($snmp_result);
    print unpack('B*', $snmp_result->{'.1.3.6.1.4.1.2544.1.12.3.1.4.1.5.1.1.5'});
    exit(1);
