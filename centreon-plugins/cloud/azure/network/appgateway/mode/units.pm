...
package cloud::azure::network::appgateway::mode::units;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'capacityunits' => {
            'output' => 'Capacity Units consumed',
            'label'  => 'capacity-units',
            'nlabel' => 'appgateway.capacity.units.count',
            'unit'   => '',
            'min'    => '0'
        },
        'computeunits' => {
            'output' => 'Compute Units consumed',
            'label'  => 'compute-units',
            'nlabel' => 'appgateway.compute.units.count',
            'unit'   => '',
            'min'    => '0'
        },
        'estimatedbilledcapacityunits' => {
            'output' => 'Estimated Billed Capacity Units',
            'label'  => 'estimated-billed-units',
            'nlabel' => 'appgateway.billed.units.estimated.count',
            'unit'   => '',
            'min'    => '0'
        },
...
Check Azure Application Gateway units statistics.
...
'estimated-billed-units', 'fixed-billable-units', 'compute-units', 'capacity-units'.
