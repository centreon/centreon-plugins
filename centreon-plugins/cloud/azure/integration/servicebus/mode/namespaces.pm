...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'namespacecpuusage' => {
            ...
            'nlabel' => 'servicebus.namespace.cpu.usage.percentage',
            'unit'   => '%',
            'min'    => '0',
            'max'    => '100'
        },
        'namespacememoryusage' => {
            ...
            'nlabel' => 'servicebus.namespace.memory.usage.percentage',
            'unit'   => '%',
            'min'    => '0',
            'max'    => '100'
        }
...
Check Azure Service Bus namespace resources statistics.
