...
You can use the following variables like: %{active}, %{readyToRun}, %{id}, %{name}
...
Set unknown threshold for status.
You can use the following variables like: %{agentName}, %{appDisplayName}, %{status}, %{desiredStatus}
