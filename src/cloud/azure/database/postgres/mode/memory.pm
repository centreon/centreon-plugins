...
package cloud::azure::database::postgres::mode::memory;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'memory_percent' => {
            ...
            'label'  => 'memory-usage',
            'nlabel' => 'azpostgres.memory.usage.percentage',
            'unit'   => '%',
            'min'    => '0',
            'max'    => '100'
        }
...
Check Azure Database for PostgreSQL memory usage.

Example:

Using resource name:

perl centreon_plugins.pl --plugin=cloud::azure::database::postgres::plugin --mode=memory --custommode=api
