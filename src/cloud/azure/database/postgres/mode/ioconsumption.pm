...
package cloud::azure::database::postgres::mode::ioconsumption;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'disk_iops_consumed_percentage' => {
            ...
            'nlabel' => 'azpostgres.ioconsumption.usage.percentage',
            'unit'   => '%',
            'min'    => '0',
            'max'    => '100'
        }
...
Check Azure Database for PostgreSQL IO comsuption usage.
