...
package cloud::azure::database::postgres::mode::traffic;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'network_bytes_egress' => {
            'output' => 'Network Out',
            'label'  => 'traffic-out',
            'nlabel' => 'azpostgres.traffic.out.bytes',
            'unit'   => 'B',
            'min'    => '0'
        },
        'network_bytes_ingress' => {
            'output' => 'Network In',
            'label'  => 'traffic-in',
            'nlabel' => 'azpostgres.traffic.in.bytes',
            'unit'   => 'B',
            'min'    => '0'
        }
    };
...
Check Azure Database for PostgreSQL network usage.

Example:

Using resource name:

perl centreon_plugins.pl --plugin=cloud::azure::database::postgres::plugin --mode=traffic --custommode=api
...
Thresholds where '*' can be: 'traffic-out', 'traffic-in'.
