...
package cloud::azure::database::postgres::mode::connections;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'active_connections' => {
            ...
            'nlabel' => 'azpostgres.connections.active.count',
            'unit'   => '',
            'min'    => '0'
        },
        'connections_failed' => {
            ...
            'nlabel' => 'azpostgres.connections.failed.count',
            'unit'   => '',
            'min'    => '0'
        },
        'aborted_connections' => {
            ...
            'nlabel' => 'azpostgres.connections.aborted.count',
            'unit'   => '',
            'min'    => '0'
        }
    };
...
sub check_options {
    ...
    my $resource_mapping = {
        ...
        'flexibleServers' => [ 'active_connections', 'connections_failed' ]
    };
...
Check Azure Database for PostgreSQL connections status.
