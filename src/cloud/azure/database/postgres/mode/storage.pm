...
package cloud::azure::database::postgres::mode::storage;
...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        'backup_storage_used' => {
            ...
            'nlabel' => 'azpostgres.storage.backup.usage.bytes',
            'unit'   => 'B',
            'min'    => '0'
        },
        'txlogs_storage_used' => {
            ...
            'nlabel' => 'azpostgres.storage.serverlog.usage.bytes',
            'unit'   => 'B',
            'min'    => '0'
        },
        'storage_percent' => {
            ...
            'nlabel' => 'azpostgres.storage.usage.percentage',
            'unit'   => '%',
            'min'    => '0'
        },
        'storage_used' => {
            'output' => 'Storage Used',
            'label'  => 'storage-used',
            'nlabel' => 'azpostgres.storage.usage.bytes',
            'unit'   => 'B',
            'min'    => '0'
        }
    };
...
sub check_options {
    ...
    my $resource_mapping = {
        'servers' => [ 'backup_storage_used', 'txlogs_storage_used', 'storage_percent', 'storage_used' ],
        'flexibleServers' => [ 'backup_storage_used', 'txlogs_storage_used', 'storage_percent', 'storage_used' ]
    };
...
Check Azure Database for PostgreSQL storage usage.
...
'storage-backup', 'serverlog-usage', 'storage-percent', 'storage-used'.
