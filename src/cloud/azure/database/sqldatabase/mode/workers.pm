...
package cloud::azure::database::sqldatabase::mode::workers;
...
Check active workers on Azure SQL Database.
...
--aggregation='total' --critical-workers='10'
