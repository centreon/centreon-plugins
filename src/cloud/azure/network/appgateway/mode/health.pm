...
package cloud::azure::network::appgateway::mode::health;
...
Check Azure Network Application Gateway status.
...
You can use the following variables like: %{status}, %{summary}
