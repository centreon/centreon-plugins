...
sub get_metrics_mapping {
    ...
    my $metrics_mapping = {
        ...
        'Disk Write Bytes' => {
            ...
            'label'  => 'write-bytes',
            'nlabel' => 'azvm.disk.write.bytes',
            'unit'   => 'B',
            'min'    => '0',
            'max'    => ''
        },
        'Disk Read Operations/Sec' => {
            'output' => 'Disk read ops/s',
            'label'  => 'read-ops-persecond',
            'nlabel' => 'azvm.disk.read.persecond',
            'unit'   => '',
            'min'    => '0',
            'max'    => ''
        },
        'Disk Write Operations/Sec' => {
            'output' => 'Disk write ops/s',
            'label'  => 'write-ops-persecond',
            'nlabel' => 'azvm.disk.write.persecond',
            'unit'   => '',
            'min'    => '0',
            'max'    => ''
        }
...
Warning thresholds.
($label$ can be: 'read-bytes', 'write-bytes', 'read-ops-persecond', 'write-ops-persecond')
...
Transform Disk Read Bytes & Disk Write Bytes in a persecond value.
