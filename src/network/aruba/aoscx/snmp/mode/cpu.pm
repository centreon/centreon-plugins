...
package network::aruba::aoscx::snmp::mode::cpu;
...
sub set_counters {
    ...
    $self->{maps_counters_type} = [
        { name => 'modules', type => 1, cb_prefix_output => 'prefix_module_output', message_multiple => 'All cpu usages are ok' }
    ];
...
sub manage_selection {
    ...
    my $oid_cpu = '.1.3.6.1.4.1.47196.4.1.1.3.22.1.0.1.1.3'; # arubaWiredSystemInfoCpu
