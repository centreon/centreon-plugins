...
You can use the following variables like: %{role}, %{config_sync}
...
Set unknown threshold for status.
You can use the following variables like: %{isl_status}
...
Set unknown threshold for status.
You can use the following variables like: %{keepalive_status}
