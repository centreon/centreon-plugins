...
You can use the following variables like: %{description}, %{object}, %{severity}, %{type}, %{acknowledged}, %{since}

=item B<--critical-status>

Set critical threshold for status (Default: '%{severity} =~ /major|critical/').
You can use the following variables like: %{description}, %{object}, %{severity}, %{type}, %{since}
