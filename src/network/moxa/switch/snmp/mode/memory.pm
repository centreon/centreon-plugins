...
my $mapping = {
    ...
    eds508a => {
        total => { oid => '.1.3.6.1.4.1.8691.7.9.1.56' },
        free  => { oid => '.1.3.6.1.4.1.8691.7.9.1.57' },
        used  => { oid => '.1.3.6.1.4.1.8691.7.9.1.58' }
    },
    edsg508e => {
        total => { oid => '.1.3.6.1.4.1.8691.7.69.1.56' },
        free  => { oid => '.1.3.6.1.4.1.8691.7.69.1.57' },
        used  => { oid => '.1.3.6.1.4.1.8691.7.69.1.58' }
    },
    edsp510a8poe => {
        total => { oid => '.1.3.6.1.4.1.8691.7.86.1.56' },
        free  => { oid => '.1.3.6.1.4.1.8691.7.86.1.57' },
        used  => { oid => '.1.3.6.1.4.1.8691.7.86.1.58' }
    },
    icsg7826a => {
        total => { oid => '.1.3.6.1.4.1.8691.7.99.1.56' },
        free  => { oid => '.1.3.6.1.4.1.8691.7.99.1.57' },
        used  => { oid => '.1.3.6.1.4.1.8691.7.99.1.58' }
    },
    icsg7850a => {
        total => { oid => '.1.3.6.1.4.1.8691.7.105.1.56' },
        free  => { oid => '.1.3.6.1.4.1.8691.7.105.1.57' },
        used  => { oid => '.1.3.6.1.4.1.8691.7.105.1.58' }
    },
    edsg512e => {
        total => { oid => '.1.3.6.1.4.1.8691.7.70.1.56' },
        free  => { oid => '.1.3.6.1.4.1.8691.7.70.1.57' },
        used  => { oid => '.1.3.6.1.4.1.8691.7.70.1.58' }
    },
    edsg512e8poe => {
    ...
    iksg6524a => {
        ...
        used  => { oid => '.1.3.6.1.4.1.8691.7.95.1.58' }
    }
};
    ...
    my $snmp_result = $options{snmp}->get_leef(
        oids => [
            map(
                ...
                values(%{$mapping->{eds506a}}),
                values(%{$mapping->{edsg508a}}),
