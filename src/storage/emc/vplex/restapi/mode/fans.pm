...
You can use the following variables like: %{operational_status}, %{engine_id}, %{fan_name}
...
Set warning threshold for status.
You can use the following variables like: %{speed_threshold_exceeded}, %{engine_id}, %{fan_name}
