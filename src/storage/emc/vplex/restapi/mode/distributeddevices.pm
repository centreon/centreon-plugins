...
You can use the following variables like: %{operational_status}, %{device_name}
...
Set warning threshold for status.
You can use the following variables like: %{health_state}, %{device_name}
...
Set warning threshold for status.
You can use the following variables like: %{service_status}, %{device_name}
