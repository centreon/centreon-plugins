...
You can use the following variables like: %{operational_status}, %{engine_id}, %{director_name}
...
Set warning threshold for status.
You can use the following variables like: %{communication_status}, %{engine_id}, %{director_name}
...
Set warning threshold for status.
You can use the following variables like: %{temperature_threshold_exceeded}, %{engine_id}, %{director_name}
...
Set warning threshold for status.
You can use the following variables like: %{voltage_threshold_exceeded}, %{engine_id}, %{director_name}
...
Set warning threshold for status.
You can use the following variables like: %{vplex_kdriver_status}, %{engine_id}, %{director_name}
