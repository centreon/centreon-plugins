...
You can use the following variables like: %{cluster_status}, %{reason_cannot_takeover}, %{partner_status}
...
Set unknown threshold for status (Default: '').
You can use the following variables like: %{status}, %{reason_cannot_takeover}, %{partner_status}, %{display}
