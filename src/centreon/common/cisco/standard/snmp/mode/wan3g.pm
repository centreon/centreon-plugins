...
You can use the following variables like: %{modem_status}, %{display}
...
You can use the following variables like: %{connection_status}, %{display}
...
You can use the following variables like: %{sim_status}, %{display}
...
You can use the following variables like: %{current_band}, %{channel_number}, %{display}
...
You can use the following variables like: %{service_status}, %{display}
