...
package centreon::common::bluearc::snmp::mode::interfaces;
...
Define the OID to be used to filter interfaces (default: ifDesc) (values: ifDesc, ifAlias, ifName, IpAddr).

=item B<--oid-display>

Define the OID that will be used to name the interfaces (default: ifDesc) (values: ifDesc, ifAlias, ifName, IpAddr).
