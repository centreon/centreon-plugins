...
package hardware::pdu::sentry::snmp::mode::sensors;
...
sub new {
    my ($class, %options) = @_;
    my $self = $class->SUPER::new(package => __PACKAGE__, %options, force_new_perfdata => 1, no_absent => 1);
    bless $self, $class;
...
Check components (humidity, temperature).
