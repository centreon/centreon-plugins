...
package hardware::sensors::rittal::cmc3::snmp::mode::uptime;
...
Select the time unit for the performance data and thresholds. May be 's' for seconds, 'm' for minutes, 'h' for hours, 'd' for days, 'w' for weeks. Default is secondss.
