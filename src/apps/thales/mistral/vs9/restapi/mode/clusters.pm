...
You can use the following variables like: %{gatewaysClusterStatus}, %{availableForSwitching}, %{clusterName}
...
Set unknown threshold for status.
You can use the following variables like: %{connectedStatus}, %{role}, %{memberName}
