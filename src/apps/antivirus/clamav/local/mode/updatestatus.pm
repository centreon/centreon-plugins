...
You can use the following variables like: %{last_engine_version}, %{current_engine_version}
...
Set warning threshold for status (Default: '')
You can use the following variables like: %{last_maindb_version}, %{current_maindb_version}, %{current_maindb_timediff}
...
Set warning threshold for status (Default: '')
You can use the following variables like: %{last_dailydb_version}, %{current_dailydb_version}, %{current_dailydb_timediff}
