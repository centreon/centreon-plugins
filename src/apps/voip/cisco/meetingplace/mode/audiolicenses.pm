...
Warning threshold: Percentage value of audio licenses usage resulting in a warning state

=item B<--critical>

Critical threshold: Percentage value of audio licenses usage resulting in a critical state
