...
Warning threshold: Percentage value of video ports usage resulting in a warning state

=item B<--critical>

Critical threshold: Percentage value of video ports usage resulting in a critical state
