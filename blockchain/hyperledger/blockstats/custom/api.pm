...
package blockchain::hyperledger::blockstats::custom::api;
...
sub check_options {
    ...
    $self->{url_path} = (defined($self->{option_results}->{url_path})) ? $self->{option_results}->{url_path} : '/BlockStatsWS/rest';
...
HyperLedger Rest API custom mode
...
API URL path (Default: '/BlockStatsWS/rest')
