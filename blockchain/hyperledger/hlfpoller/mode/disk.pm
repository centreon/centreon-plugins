...
package blockchain::hyperledger::hlfpoller::mode::disk;
...
sub set_counters {
    ...
    $self->{maps_counters}->{global} = [
       { label => 'disk-free', nlabel => 'hlf.poller.disk.free', set => {
        ...
        { label => 'disk-available', nlabel => 'hlf.poller.disk.available', set => {
        ...
        { label => 'disk-size', nlabel => 'hlf.poller.disk.size', set => {
        ...
        { label => 'disk-used', nlabel => 'hlf.poller.disk.used', set => {
        ...
        { label => 'disk-usage', nlabel => 'hlf.poller.disk.usage', set => {
        ...
        { label => 'blockchain-dir', nlabel => 'hlf.poller.blockchain.directory', set => {
...
Check hyperledger fabric poller for disk monitoring
