...
package blockchain::hyperledger::hlfpoller::custom::api;
...
Hyperledger Fabric poller Rest API

=head1 SYNOPSIS

Hyperledger Fabric poller Rest API custom mode
...
Hyperledger Fabric poller API hostname.
