...
package hardware::devices::pexip::infinity::managementapi::plugin;
...
Check Pexip Infinity using management API.
If you use http curl backend (try: --curl-opt="CURLOPT_SSL_VERIFYPEER => 0" --curl-opt="CURLOPT_SSL_VERIFYHOST => 0")
