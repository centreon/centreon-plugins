...
package hardware::server::dell::ome_modular::snmp::mode::hardware;
...
sub set_system {
    ...
    $self->{components_path} = 'hardware::server::dell::ome_modular::snmp::mode::components';
...
sub display_system_information {
    ...
    $self->{output}->output_add(
        long_msg => sprintf("Product Name: %s, Service Tag: %s, Firmware Version of MM1: %s, Firmware Version of MM2: %s",
