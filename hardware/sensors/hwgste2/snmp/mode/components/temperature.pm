...
package hardware::sensors::hwgste2::snmp::mode::components::temperature;

use strict;
use warnings;
use hardware::sensors::hwgste2::snmp::mode::components::resources qw($mapping);

my $oid_sensEntry = '.1.3.6.1.4.1.21796.4.9';
