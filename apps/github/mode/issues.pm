...
sub run {
    ...
    $self->{option_results}->{url_path} = $self->{option_results}->{url_path}."/".$self->{option_results}->{user}."/".$self->{option_results}->{repository}."/issues";
...
Set path to get GitHub's api issues information (Default: '/issues')
