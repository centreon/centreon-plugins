...
*** Variables ***
${MOCKOON_JSON}         ${CURDIR}${/}centreonvault.mockoon.json
...
Linux Memory with vault ${tc}
    ...
    Examples:         tc  secret    vault_config                                extra_options       expected_regexp    --
            ...
            ...       2   Linux     ${CURDIR}${/}vault.json                     ${EMPTY}            UNKNOWN: File '.*/centreon/plugins/passwordmgr/vault.json' could not be found.
            ...       3   Linux     ${CURDIR}${/}vault_config_incomplete.json   ${EMPTY}            UNKNOWN: Unable to authenticate to the vault: role_id or secret_id is empty.
            ...       4   Linux     ${CURDIR}${/}vault_config_plain.json        --debug            OK: Ram Total: 1.92 GB Used
            ...       5   Linux     ${CURDIR}${/}vault_config_encrypted.json    --vault-env-file=${CURDIR}${/}env           OK: Ram Total: 1.92 GB Used
