...
Antivirus ${tc}
    ...
    Examples:        tc    extra_options                         expected_result    --
            ...
            ...      4     --warning-license-expires='1'         WARNING: antivirus 'Anonymized 008' license expires in \\\\d+y \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s - antivirus 'Anonymized 106' license expires in \\\\d+y \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s \\\\| 'antivirus.database.lastupdate.seconds'=\\\\d+s;;;0; 'Anonymized 008#antivirus.license.expires.seconds'=\\\\d+s;0:1;;0; 'antivirus.database.lastupdate.seconds'=\\\\d+s;;;0; 'Anonymized 106#antivirus.license.expires.seconds'=\\\\d+s;0:1;;0;
            ...      5     --critical-license-expires='1'        CRITICAL: antivirus 'Anonymized 008' license expires in \\\\d+y \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s - antivirus 'Anonymized 106' license expires in \\\\d+y \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s \\\\| 'antivirus.database.lastupdate.seconds'=\\\\d+s;;;0; 'Anonymized 008#antivirus.license.expires.seconds'=\\\\d+s;;0:1;0; 'antivirus.database.lastupdate.seconds'=\\\\d+s;;;0; 'Anonymized 106#antivirus.license.expires.seconds'=\\\\d+s;;0:1;0;
            ...      6     --warning-database-last-update='1'    WARNING: antivirus 'Anonymized 008' database last update \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s - antivirus 'Anonymized 106' database last update \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s \\\\| 'antivirus.database.lastupdate.seconds'=\\\\d+s;0:1;;0; 'Anonymized 008#antivirus.license.expires.seconds'=\\\\d+s;;;0; 'antivirus.database.lastupdate.seconds'=\\\\d+s;0:1;;0; 'Anonymized 106#antivirus.license.expires.seconds'=\\\\d+s;;;0;
            ...      7     --critical-database-last-update='1'   CRITICAL: antivirus 'Anonymized 008' database last update \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s - antivirus 'Anonymized 106' database last update \\\\d+M \\\\d+w \\\\d+d \\\\d+h \\\\d+m \\\\d+s \\\\| 'antivirus.database.lastupdate.seconds'=\\\\d+s;;0:1;0; 'Anonymized 008#antivirus.license.expires.seconds'=\\\\d+s;;;0; 'antivirus.database.lastupdate.seconds'=\\\\d+s;;0:1;0; 'Anonymized 106#antivirus.license.expires.seconds'=\\\\d+s;;;0;