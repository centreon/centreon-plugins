...
call-statistics ${tc}
    ...
    Examples:        tc     extra_options                                                              expected_result    --
            ...      1      ${EMPTY}                                                                   OK: All ports call statistics are ok | '1#port.calls.current.count'=5;;;0; '1#port.calls.total.count'=0;;;0; '1#port.calls.connected.count'=0;;;0; '1#port.calls.refused.count'=0;;;0; '1#port.calls.errored.count'=0;;;0; '1#port.calls.blocked.count'=0;;;0; '2#port.calls.current.count'=7;;;0; '2#port.calls.total.count'=0;;;0; '2#port.calls.connected.count'=0;;;0; '2#port.calls.refused.count'=0;;;0; '2#port.calls.errored.count'=0;;;0; '2#port.calls.blocked.count'=0;;;0; '3#port.calls.current.count'=9;;;0; '3#port.calls.total.count'=0;;;0; '3#port.calls.connected.count'=0;;;0; '3#port.calls.refused.count'=0;;;0; '3#port.calls.errored.count'=0;;;0; '3#port.calls.blocked.count'=0;;;0;
