...
Connections SN910 ${tc}
    ...
    ...    1
    ...    ${EMPTY}
    ...    OK: Memory usage total: 15.00 %, protected host: 0.00 %, fragmented: 0.00 %, ASQ connections: 0.00%, icmp: 7.00 %, Data Tracking: 0.00%, dynamic: 1.00 %, EtherState: 0%, Socket: 0%, User: 7% | 'memory.usage.percentage'=15.00%;;;0;100 'memory.protected_host.percentage'=0.00%;;;0;100 'memory.fragmented.percentage'=0.00%;;;0;100 'memory.connections.percentage'=0.00%;;;0;100 'memory.icmp.percentage'=7.00%;;;0;100 'memory.data_tracking.percentage'=0.00%;;;0;100 'memory.dynamic.percentage'=1.00%;;;0;100 'memory.ether_state.percentage'=0.00%;;;0;100 'memory.socket.percentage'=0%;;;0;100 'memory.user.percentage'=7%;;;0;100
    ...    2
    ...    --warning-total=4
    ...    WARNING: Memory usage total: 15.00 % | 'memory.usage.percentage'=15.00%;0:4;;0;100 'memory.protected_host.percentage'=0.00%;;;0;100 'memory.fragmented.percentage'=0.00%;;;0;100 'memory.connections.percentage'=0.00%;;;0;100 'memory.icmp.percentage'=7.00%;;;0;100 'memory.data_tracking.percentage'=0.00%;;;0;100 'memory.dynamic.percentage'=1.00%;;;0;100 'memory.ether_state.percentage'=0.00%;;;0;100 'memory.socket.percentage'=0%;;;0;100 'memory.user.percentage'=7%;;;0;100
    ...    3
    ...    --critical-dyn=4:
