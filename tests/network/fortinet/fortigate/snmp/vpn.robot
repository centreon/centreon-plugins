...
vpn ${tc}
    ...
    Examples:        tc    extra_options                                                                                                                            expected_result    --
            ...
            ...      8     --disco-format                                                                                                                           <?xml version="1.0" encoding="utf-8"?> <data> <element>name</element> <element>vdom</element> <element>state</element> </data>
            ...      9     --disco-show                                                                                                                             <?xml version="1.0" encoding="utf-8"?> <data> <label name="Anonymized 017" state="up" vdom="Anonymized 220"/> <label name="Anonymized 027" state="up" vdom="Anonymized 220"/> <label name="Anonymized 057" state="up" vdom="Anonymized 220"/> <label name="Anonymized 209" state="up" vdom="Anonymized 220"/> <label name="Anonymized 217" state="up" vdom="Anonymized 220"/> <label name="Anonymized 244" state="up" vdom="Anonymized 220"/> </data>
