...
ha-status ${tc}
    ...
    Examples:        tc    extra_options                                                                                                       expected_result    --
            ...
            ...      6     --warning-status='\\\%{hastatus} ne "enabled"'                                                                      WARNING: Current HA State: 'primary' Peer HA State: 'auxiliary' HA Port: 'Anonymized 007' HA IP: '192.168.42.167' Peer IP: '192.168.42.23'
            ...
            ...      8     --critical-status='\\\%{peer_hastate} ne "auxiliary"'                                                               OK: Current HA State: 'primary' Peer HA State: 'auxiliary' HA Port: 'Anonymized 007' HA IP: '192.168.42.167' Peer IP: '192.168.42.23'