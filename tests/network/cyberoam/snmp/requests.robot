...
requests ${tc}
    ...
    Examples:        tc    extra_options                                                                                             expected_result    --
            ...      1     --filter-counters='' --verbose                                                                            OK: Requests live users: 38, http hits: 0, ftp hits: 0, pop3 hits: 0, imap hits: 0, smtp hits: 0 | 'live_users'=38;;;0; 'http_hits'=0;;;0; 'ftp_hits'=0;;;0; 'pop3_hits'=0;;;0; 'imap_hits'=0;;;0; 'smtp_hits'=0;;;0;
            ...      2     --filter-counters='http-hits' --verbose                                                                   OK: Requests http hits: 0 | 'http_hits'=0;;;0;
