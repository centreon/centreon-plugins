...
requests ${tc}
    ...
    Examples:        tc    extra_options                                                                                             expected_result    --
            ...
            ...      2     --filter-counters='http-hits' --warning-live-users --critical-live-users                                  OK: Requests http hits: 0 | 'http_hits'=0;;;0;
            ...      3     --warning-live-users=10 --critical-live-users=0                                                           CRITICAL: Requests live users: 38 | 'live_users'=38;0:10;0:0;0; 'http_hits'=0;;;0; 'ftp_hits'=0;;;0; 'pop3_hits'=0;;;0; 'imap_hits'=0;;;0; 'smtp_hits'=0;;;0;
