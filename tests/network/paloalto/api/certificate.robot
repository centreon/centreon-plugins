...
Certificate ${tc}
    ...
    ...    1
    ...    ${EMPTY}
    ...    CRITICAL: Device 'fw-tokyo.example.com' (FW-TOKYO) certificate status: Expired \\\| 'fw-london.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-nyc.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-tokyo.example.com#device.certificate.expiry.days'=.*;;;0;
    ...    2
    ...    --filter-counters=certificate
    ...    CRITICAL: Device 'fw-tokyo.example.com' (FW-TOKYO) certificate status: Expired \\\| 'fw-london.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-nyc.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-tokyo.example.com#device.certificate.expiry.days'=.*;;;0;
    ...    3
    ...    --include-device-serial=LON
    ...    OK: Device 'fw-london.example.com' (FW-LONDON) certificate status: Valid, expires in: -316 days \\\| 'fw-london.example.com#device.certificate.expiry.days'=.*;;;0;
    ...    4
    ...    --exclude-device-serial=TOK
    ...    OK: All device certificates are OK \\\| 'fw-london.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-nyc.example.com#device.certificate.expiry.days'=.*;;;0;
    ...    5
    ...
    ...    UNKNOWN: Device 'fw-tokyo.example.com' (FW-TOKYO) certificate status: Expired \\\| 'fw-london.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-nyc.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-tokyo.example.com#device.certificate.expiry.days'=.*;;;0;
    ...    9
    ...    --warning-certificate-status='\\\%{cert_status}=~/Expired/' --critical-certificate-status=
    ...    WARNING: Device 'fw-tokyo.example.com' (FW-TOKYO) certificate status: Expired \\\| 'fw-london.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-nyc.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-tokyo.example.com#device.certificate.expiry.days'=.*;;;0;
    ...    10
    ...    --critical-certificate-status="\\\%{cert_status} ne ''"
    ...    CRITICAL: Device 'fw-london.example.com' (FW-LONDON) certificate status: Valid - Device 'fw-nyc.example.com' (FW-NYC) certificate status: Valid - Device 'fw-tokyo.example.com' (FW-TOKYO) certificate status: Expired \\\| 'fw-london.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-nyc.example.com#device.certificate.expiry.days'=.*;;;0; 'fw-tokyo.example.com#device.certificate.expiry.days'=.*;;;0;
    ...    11
