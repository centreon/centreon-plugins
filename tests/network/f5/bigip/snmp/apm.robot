...
apm ${tc}
    ...
    Examples:        tc    extra_options                                                           expected_result    --
            ...
            ...      2     --filter-vs='.*'                                                        OK: sessions-created : Buffer creation, active sessions: 3724, pending sessions: 146 - All virtual servers are ok | 'system.sessions.active.count'=3724;;;0; 'system.sessions.pending.count'=146;;;0;
