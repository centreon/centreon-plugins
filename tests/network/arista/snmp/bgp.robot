...
bgp ${tc}
    ...
    ...           8     --include-local-addr='192\.168'                               OK: number of peers detected: 1 - Peer [description: Test 2, localAddr: 192.168.170.10:34011, localAs: 65011, remoteAddr: 192.168.1.10:12111, remoteAs: 65111] state: idle [admin status: halted] | 'bgp.peers.detected.count'=1;;;0;
