...
Volume ${tc}
    ...
    Examples:    tc    extra_options                                                                      expected_result    --
        ...
        ...      8     --pool-name=default --include-path=vm2.qcow2                                       OK: Volume 'default/vm2.qcow2' allocated: 3.00 GB / capacity: 10.00 GB (30.00 %), allocated: 30.00 % | 'default/vm2.qcow2#volume.allocation.bytes'=3221225472B;;;0;10737418240 'default/vm2.qcow2#volume.allocation.percentage'=30.00%;;;0;100
        ...      9     --pool-name=default --exclude-path=vm2.qcow2                                       OK: Volume 'default/vm1.qcow2' allocated: 5.50 GB / capacity: 20.00 GB (27.50 %), allocated: 27.50 % | 'default/vm1.qcow2#volume.allocation.bytes'=5905580032B;;;0;21474836480 'default/vm1.qcow2#volume.allocation.percentage'=27.50%;;;0;100
