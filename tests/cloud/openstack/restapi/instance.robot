...
Instance ${tc}
    ...
    Examples:        tc    extraoptions                                             expected_string    --
            ...
            ...      4     --include-name=test                                      OK: Instance count: 1 - Instance da-test is in ACTIVE state (vm_state: active), Id: 489e5eaf-eab5-48ba-b7f6-1e4b29d4d473, Host: localhost.com, Image: 97061229-2e66-4486-98b8-ce8f835248d1, Flavor: 1, Ip: 192.168.222.218, Bookmark: http://127.0.0.1:8764/servers/489e5eaf-eab5-48ba-b7f6-1e4b29d4d473, Project-id: 3903cb485951437bb6638ec42f46d8ab, Instance-name: instance-00000001, Zone: nova | 'instance.count'=1;;;0;
