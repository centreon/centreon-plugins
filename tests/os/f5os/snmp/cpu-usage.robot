...
cpu-usage ${tc}
    ...
    Examples:        tc    extra_options                                                                    expected_result    --
            ...
            ...      6     --include-id=1 --include-name='Anonymized 118'                                   OK: CPU '1' CPU Usage Current : 16 %, CPU Usage 5sec : 10 %, CPU Usage 1min : 15 %, CPU Usage 5min : 50 % | '1#cpu.core.current.usage.percent'=16%;;;0;100 '1#cpu.core.usage.avg.5s.percent'=10%;;;0;100 '1#cpu.core.usage.avg.1m.percent'=15%;;;0;100 '1#cpu.core.usage.avg.5m.percent'=50%;;;0;100
