...
Cluster ${tc}
    ...
    Examples:         tc  extra_options                                                      expected_result    --
            ...       1   ${EMPTY}                                                           OK: cluster 'cluster1' read : Buffer creation, write : Buffer creation, other : Buffer creation, total : Buffer creation, read iops: 200, write iops: 100, other iops: 100, total iops: 1000, read latency: 0.2 ms, write latency: 0.1 ms, other latency: 0.1 ms, total latency: 1 ms - node 'node-01' state: online [link status: string] | 'cluster1#cluster.io.read.usage.iops'=200iops;;;0; 'cluster1#cluster.io.write.usage.iops'=100iops;;;0; 'cluster1#cluster.io.other.usage.iops'=100iops;;;0; 'cluster1#cluster.io.total.usage.iops'=1000iops;;;0; 'cluster.io.read.latency.milliseconds'=0.2ms;;;0; 'cluster1#cluster.io.write.latency.milliseconds'=0.1ms;;;0; 'cluster.io.other.latency.milliseconds'=0.1ms;;;0; 'cluster1#cluster.io.total.latency.milliseconds'=1ms;;;0;
            ...       2   ${EMPTY}                                                           OK: cluster 'cluster1' read iops: 200, write iops: 100, other iops: 100, total iops: 1000, read latency: 0.2 ms, write latency: 0.1 ms, other latency: 0.1 ms, total latency: 1 ms - node 'node-01' state: online [link status: string] | 'cluster1#cluster.io.read.usage.bytespersecond'=0B/s;;;; 'cluster1#cluster.io.write.usage.bytespersecond'=0B/s;;;0; 'cluster1#cluster.io.other.usage.bytespersecond'=0B/s;;;; 'cluster1#cluster.io.total.usage.bytespersecond'=0B/s;;;0; 'cluster1#cluster.io.read.usage.iops'=200iops;;;0; 'cluster1#cluster.io.write.usage.iops'=100iops;;;0; 'cluster1#cluster.io.other.usage.iops'=100iops;;;0; 'cluster1#cluster.io.total.usage.iops'=1000iops;;;0; 'cluster.io.read.latency.milliseconds'=0.2ms;;;0; 'cluster1#cluster.io.write.latency.milliseconds'=0.1ms;;;0; 'cluster.io.other.latency.milliseconds'=0.1ms;;;0; 'cluster1#cluster.io.total.latency.milliseconds'=1ms;;;0;
