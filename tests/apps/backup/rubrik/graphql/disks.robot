...
Disks ${tc}
    ...
    ...    UNKNOWN: Cluster 'TEST-IN' Node 'nodeA' Disk 'sda' status: active - Node 'nodeB' Disk 'sdb' status: active - Cluster 'TEST-VI' Node 'nodeA' Disk 'sda' status: active - Node 'nodeB' Disk 'sdb' status: active - Node 'nodeC' Disk 'sdc' status: active - Cluster 'TEST-OS' Node 'nodeA' Disk 'sda' status: active - Node 'nodeA' Disk 'sdb' status: active | 'TEST-IN#cluster.disks.total.count'=2;;;0; 'TEST-IN#cluster.disks.active.count'=2;;;0;2 'TEST-VI#cluster.disks.total.count'=3;;;0; 'TEST-VI#cluster.disks.active.count'=3;;;0;3 'TEST-OS#cluster.disks.total.count'=2;;;0; 'TEST-OS#cluster.disks.active.count'=2;;;0;2
    ...    9
    ...    --warning-disk-status=1
    ...    WARNING: Cluster 'TEST-IN' Node 'nodeA' Disk 'sda' status: active - Node 'nodeB' Disk 'sdb' status: active - Cluster 'TEST-VI' Node 'nodeA' Disk 'sda' status: active - Node 'nodeB' Disk 'sdb' status: active - Node 'nodeC' Disk 'sdc' status: active - Cluster 'TEST-OS' Node 'nodeA' Disk 'sda' status: active - Node 'nodeA' Disk 'sdb' status: active | 'TEST-IN#cluster.disks.total.count'=2;;;0; 'TEST-IN#cluster.disks.active.count'=2;;;0;2 'TEST-VI#cluster.disks.total.count'=3;;;0; 'TEST-VI#cluster.disks.active.count'=3;;;0;3 'TEST-OS#cluster.disks.total.count'=2;;;0; 'TEST-OS#cluster.disks.active.count'=2;;;0;2
    ...    10
    ...    --critical-disk-status=1
    ...    CRITICAL: Cluster 'TEST-IN' Node 'nodeA' Disk 'sda' status: active - Node 'nodeB' Disk 'sdb' status: active - Cluster 'TEST-VI' Node 'nodeA' Disk 'sda' status: active - Node 'nodeB' Disk 'sdb' status: active - Node 'nodeC' Disk 'sdc' status: active - Cluster 'TEST-OS' Node 'nodeA' Disk 'sda' status: active - Node 'nodeA' Disk 'sdb' status: active | 'TEST-IN#cluster.disks.total.count'=2;;;0; 'TEST-IN#cluster.disks.active.count'=2;;;0;2 'TEST-VI#cluster.disks.total.count'=3;;;0; 'TEST-VI#cluster.disks.active.count'=3;;;0;3 'TEST-OS#cluster.disks.total.count'=2;;;0; 'TEST-OS#cluster.disks.active.count'=2;;;0;2
    ...    11
