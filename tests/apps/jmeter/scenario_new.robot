...
Scenario ${tc}
    ...
    ...    1     test_2_2    ${EMPTY}        OK: Elapsed Time: 1.457s, Steps: 2/2, Availability: 100% | 'time'=1.457s;;;0; 'steps'=2;;;0;2 'availability'=100%;;;0;100
    ...    2     test_2_2    --warning-time=1     WARNING: Elapsed Time: 1.457s | 'time'=1.457s;0:1;;0; 'steps'=2;;;0;2 'availability'=100%;;;0;100
    ...    3     test_1_2    --critical-time=1    CRITICAL: Steps: 1/2 - First failed: Sample Label 2 (404 Not Found) | 'time'=0.457s;;0:1;0; 'steps'=1;;;0;2 'availability'=50%;;;0;100
    ...
    ...    6     test_2_2    --verbose       OK: Elapsed Time: 1.457s, Steps: 2/2, Availability: 100% | 'time'=1.457s;;;0; 'steps'=2;;;0;2 'availability'=100%;;;0;100\n* Sample: Sample Label\n- Success: true\n- Elapsed Time: 0.123s\n- Response Code: 200\n- Response Message: OK\n- Assertion: Response Assertion\n* Sample: Sample Label 2\n- Success: true\n- Elapsed Time: 1.456s\n- Response Code: 200\n- Response Message: OK\n- Assertion: Response 2 Assertion
