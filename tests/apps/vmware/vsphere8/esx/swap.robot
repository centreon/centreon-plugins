...
Swap ${tc}
    ...
    Examples:    tc    extraoptions                                        expected_result   --
        ...
        ...      2     ${EMPTY}                                            OK: Swap usage: 120.56 MB (target is 1.00 TB), Percent used: 0.01% | 'swap.usage.bytes'=126419660.8B;;;;1099511627776 'swap.usage.percent'=0.0114978011697531%;;;0;100
        ...      3     --add-rates                                         OK: Swap usage: 120.56 MB (target is 1.00 TB), Percent used: 0.01% - Swap read rate is: 6.39 MB/s, Swap write rate is: 1.21 MB/s | 'swap.usage.bytes'=126419660.8B;;;;1099511627776 'swap.usage.percent'=0.0114978011697531%;;;0;100 'swap.read-rate.bytespersecond'=6700236.8Bps;;;; 'swap.write-rate.bytespersecond'=1264128Bps;;;;
        ...
        ...      8     --warning-usage-bytes=1                             WARNING: Swap usage: 120.56 MB (target is 1.00 TB) | 'swap.usage.bytes'=126419660.8B;0:1;;;1099511627776 'swap.usage.percent'=0.0114978011697531%;;;0;100
        ...      9     --critical-usage-bytes=1                            CRITICAL: Swap usage: 120.56 MB (target is 1.00 TB) | 'swap.usage.bytes'=126419660.8B;;0:1;;1099511627776 'swap.usage.percent'=0.0114978011697531%;;;0;100
