...
Disk-Io ${tc}
    ...
    Examples:    tc    extraoptions                              expected_result   --
        ...      1     ${EMPTY}                                  UNKNOWN: no data for resource host-22 counter disk.throughput.usage.HOST at the moment. - no data for resource host-22 counter disk.throughput.contention.HOST at the moment. - get_esx_stats function failed to retrieve stats The counter disk.throughput.usage.HOST was not recorded for resource host-22 before. It will now (creating acq_spec). The counter disk.throughput.contention.HOST was not recorded for resource host-22 before. It will now (creating acq_spec).
