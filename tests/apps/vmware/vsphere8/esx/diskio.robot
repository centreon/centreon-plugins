...
Disk-Io ${tc}
    ...
    Examples:    tc    extraoptions                              expected_result   --
        ...      1     ${EMPTY}                                  OK: usage-bps : skipped (no value(s)), contention-ms : skipped (no value(s)) - no data for resource host-22 counter disk.throughput.usage.HOST at the moment. - no data for resource host-22 counter disk.throughput.contention.HOST at the moment.
