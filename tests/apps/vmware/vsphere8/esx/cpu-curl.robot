...
Cpu with curl ${tc}
    ...
    Examples:    tc    extraoptions                                        expected_result   --
        ...      1     ${EMPTY}                                            OK: usage-prct : skipped (no value(s)), usage-frequency : skipped (no value(s)) - no data for resource host-22 counter cpu.capacity.provisioned.HOST at the moment.
