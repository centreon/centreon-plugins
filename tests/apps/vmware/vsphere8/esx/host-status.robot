...
Host-Status ${tc}
    ...
    Examples:    tc     filter_host                 extraoptions                        expected_result   --
        ...
        ...      5      --esx-name=nothing          ${EMPTY}                            UNKNOWN: No ESX Host found with name: 'nothing' and id: ''.
        ...      6      --esx-id=host-35            --esx-name=esx2.acme.com            UNKNOWN: No ESX Host found with name: 'esx2.acme.com' and id: 'host-35'.
        ...
        ...     10      --esx-id=nothing            ${EMPTY}                            UNKNOWN: No ESX Host found with name: '' and id: 'nothing'.
