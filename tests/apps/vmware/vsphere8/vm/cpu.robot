...
Cpu ${tc}
    ...
    Examples:    tc    extraoptions                                        expected_result   --
        ...      1     ${EMPTY}                                            OK: usage-prct : skipped (no value(s)), usage-frequency : skipped (no value(s)) - no data for host vm-7722 counter cpu.capacity.entitlement.VM at the moment.
