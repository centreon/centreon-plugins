...
Requests ${tc}
    ...
    Examples:    tc    extra_options                                       expected_result    --
        ...
        ...      2     --urlpath=/server-status-2                          OK: BytesPerSec: \\\\d+.\\\\d+ KB, AccessPerSec: \\\\d+.\\\\d+, RequestPerSec: 300.00, BytesPerRequest: 1.25 KB \\\\| 'apache.bytes.persecond'=\\\\d+.00B;;;0; 'apache.access.persecond'=\\\\d+.00;;;0; 'apache.request.average.persecond'=300.00;;;0; 'apache.bytes.average.perrequest'=1284.23B;;;0; 'apache.bytes.average.persecond'=100B;;;0;
        ...
        ...      4     --warning-apache.bytes.persecond=:400               WARNING: BytesPerSec: \\\\d+.\\\\d+ MB \\\\| 'apache.bytes.persecond'=\\\\d+.00B;0:400;;0; 'apache.access.persecond'=\\\\d+.00;;;0; 'apache.request.average.persecond'=300.00;;;0; 'apache.bytes.average.perrequest'=2211284.85B;;;0; 'apache.bytes.average.persecond'=10B;;;0;
        ...      5     --critical-apache-access-persecond=:10 --urlpath=/server-status-2    CRITICAL: AccessPerSec: \\\\d+.\\\\d+ \\\\| 'apache.bytes.persecond'=\\\\d+.00B;;;0; 'apache.access.persecond'=\\\\d+.00;;0:10;0; 'apache.request.average.persecond'=300.00;;;0; 'apache.bytes.average.perrequest'=1284.23B;;;0; 'apache.bytes.average.persecond'=100B;;;0;
        ...
        ...      7     --warning-apache-bytes-average-perrequest=:10 --urlpath=/server-status-2      WARNING: BytesPerRequest: \\\\d+.\\\\d+ KB \\\\| 'apache.bytes.persecond'=\\\\d+.00B;;;0; 'apache.access.persecond'=\\\\d+.00;;;0; 'apache.request.average.persecond'=300.00;;;0; 'apache.bytes.average.perrequest'=1284.23B;0:10;;0; 'apache.bytes.average.persecond'=100B;;;0;
        ...
        ...      10     --critical-access=:10                               CRITICAL: AccessPerSec: \\\\d+.\\\\d+ \\\\| 'apache.bytes.persecond'=\\\\d+.00B;;;0; 'apache.access.persecond'=\\\\d+.00;;0:10;0; 'apache.request.average.persecond'=300.00;;;0; 'apache.bytes.average.perrequest'=2211284.85B;;;0; 'apache.bytes.average.persecond'=10B;;;0;
        ...      11    --warning-bytes=:10 --urlpath=/server-status-2      WARNING: BytesPerSec: \\\\d+.\\\\d+ KB \\\\| 'apache.bytes.persecond'=\\\\d+.00B;0:10;;0; 'apache.access.persecond'=\\\\d+.00;;;0; 'apache.request.average.persecond'=300.00;;;0; 'apache.bytes.average.perrequest'=1284.23B;;;0; 'apache.bytes.average.persecond'=100B;;;0;
