...
System ${tc}
    ...
    ...    WARNING: active calls usage total: 24 used: 1 (4.17%) free: 23 (95.83%) | 'system.calls.active.usage.count'=1;2:;;0;24 'system.calls.active.free.count'=23;;;0;24 'system.calls.active.usage.percentage'=4.17;;;0;24 'system.extensions.registered.count'=49;;;0;53 'system.extensions.usage.count'=53;;;0;120 'system.extensions.free.count'=67;;;0;120 'system.extensions.usage.percentage'=44.17%;;;0;100
    ...    10
    ...    --critical-calls-active-usage=2:
    ...    CRITICAL: active calls usage total: 24 used: 1 (4.17%) free: 23 (95.83%) | 'system.calls.active.usage.count'=1;;2:;0;24 'system.calls.active.free.count'=23;;;0;24 'system.calls.active.usage.percentage'=4.17;;;0;24 'system.extensions.registered.count'=49;;;0;53 'system.extensions.usage.count'=53;;;0;120 'system.extensions.free.count'=67;;;0;120 'system.extensions.usage.percentage'=44.17%;;;0;100
    ...    11
    ...    --warning-calls-active-free=1
    ...    WARNING: active calls usage total: 24 used: 1 (4.17%) free: 23 (95.83%) | 'system.calls.active.usage.count'=1;;;0;24 'system.calls.active.free.count'=23;0:1;;0;24 'system.calls.active.usage.percentage'=4.17;;;0;24 'system.extensions.registered.count'=49;;;0;53 'system.extensions.usage.count'=53;;;0;120 'system.extensions.free.count'=67;;;0;120 'system.extensions.usage.percentage'=44.17%;;;0;100
    ...    12
    ...    --critical-calls-active-free=1
    ...    CRITICAL: active calls usage total: 24 used: 1 (4.17%) free: 23 (95.83%) | 'system.calls.active.usage.count'=1;;;0;24 'system.calls.active.free.count'=23;;0:1;0;24 'system.calls.active.usage.percentage'=4.17;;;0;24 'system.extensions.registered.count'=49;;;0;53 'system.extensions.usage.count'=53;;;0;120 'system.extensions.free.count'=67;;;0;120 'system.extensions.usage.percentage'=44.17%;;;0;100
    ...    13
