...
# --component 'temperature' --warning='humidity,.,45:65' --critical='humidity,.,35:70'
    ...
    ...    _empty_
    ...    _empty_
    ...    OK: All 2 components are ok [2/2 temperatures]. | 'Main Module:Sonde de temperature#hardware.sensor.temperature.celsius'=23C;;;; 'Main Module:Sonde de temperature#hardware.sensor.humidity.percentage'=35%;;;0;100 'hardware.temperature.count'=2;;;;
    ...    2
    ...    _empty_
    ...    humidity,.,45:65
    ...    _empty_
    ...    WARNING: Humidity 'Main Module:Sonde de temperature' is 35 % | 'Main Module:Sonde de temperature#hardware.sensor.temperature.celsius'=23C;;;; 'Main Module:Sonde de temperature#hardware.sensor.humidity.percentage'=35%;45:65;;0;100 'hardware.temperature.count'=2;;;;
    ...    3
    ...    _empty_
    ...    humidity,.,45:65
    ...    humidity,.,35:70
    ...
    ...    temperature,.,22:25
    ...    temperature,.,22:25
    ...    OK: All 2 components are ok [2/2 temperatures]. | 'Main Module:Sonde de temperature#hardware.sensor.temperature.celsius'=23C;22:25;22:25;; 'Main Module:Sonde de temperature#hardware.sensor.humidity.percentage'=35%;;;0;100 'hardware.temperature.count'=2;;;;
    ...    9
    ...    _empty_
    ...    _empty_
    ...    _empty_
